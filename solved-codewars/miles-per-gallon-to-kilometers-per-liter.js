...
Some useful associations relevant to this kata: 1 Imperial Gallon = 4.54609188 
litres 1 Mile = 1.609344 kilometres
*/

function converter(mpg) {
  const mile = 1.609344;
  const gallon = 4.54609188;
  return Math.round(mpg / gallon * mile * 100) / 100;
}
/*   ARBA
function converter (mpg) {
...
test("test", () => {
  expect(converter(12)).toBe(4.25);
  expect(converter(24)).toBe(8.50);
  expect(converter(36)).toBe(12.74);
})